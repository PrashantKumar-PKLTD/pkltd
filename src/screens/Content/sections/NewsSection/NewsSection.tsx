...
export const NewsSection = (): JSX.Element => {
  return (
    <section className="flex-col w-full items-center justify-center px-0 py-[98px] flex-[0_0_auto] bg-darkbasic flex relative">
      <div className="w-full max-w-[1312px] items-center justify-center flex-[0_0_auto] flex flex-col relative px-4">
        <div className="items-start justify-center gap-8 self-stretch w-full flex-[0_0_auto] flex relative">
          <div className="flex flex-col w-[528px] items-start justify-center gap-8 relative translate-y-[-1rem] animate-fade-in opacity-0">
          ...
          <div className="flex flex-col items-start gap-7 relative flex-1 grow translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
