...
export const Home = (): JSX.Element => {
  const filterItems = [
    ...
    { label: "Data", number: "03", fontWeight: "font-medium" },
    { label: "Agile", number: "04", fontWeight: "font-bold" },
    { label: "Digital", number: "05", fontWeight: "font-bold" },
    { label: "Creative", number: "06", fontWeight: "font-medium" },
    { label: "Technology", number: "07", fontWeight: "font-medium" },
  ];
  ...
  return (
    ...
    <div className="relative w-[1680px] h-[850px] bg-white overflow-hidden">
      <div className="relative -top-[300px]">
        ...
        <div className="absolute top-0 left-[364px] w-[960px] h-[960px] rounded-[480px] [background:radial-gradient(50%_50%_at_50%_50%,rgba(255,233,68,0.75)_0%,rgba(255,233,68,0)_100%)]" />
