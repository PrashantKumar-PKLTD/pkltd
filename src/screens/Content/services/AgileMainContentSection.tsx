...
const servicesData = [
  {
    ...
    description:
      "Guiding organizations through agile transformation with expert coaching, training, and strategic implementation of agile methodologies.",
  },
  {
    category: "DESIGN",
    title: "Scrum & Kanban Implementation",
    description:
      "Setting up effective Scrum and Kanban frameworks tailored to your team's needs and organizational structure.",
  },
  {
    category: "PRODUCTION",
    title: "Team Training & Development",
    description:
      "Comprehensive training programs for teams, product owners, and scrum masters to maximize agile effectiveness.",
  },
  {
    category: "CAMPAIGNS",
    title: "Process Optimization & Scaling",
    description:
      "Optimizing agile processes, scaling frameworks across multiple teams, and ensuring continuous improvement.",
  },
];
...
const processSteps = [
  {
    ...
    title: "Agile Assessment and Strategy",
    description:
      "We evaluate your current processes, identify improvement opportunities, and develop a customized agile transformation strategy that fits your organization's culture and goals.",
    image: "https://c.animaapp.com/mfo404djpVGKfZ/img/image-2.png",
  },
  {
    stepNumber: "STEP NUMBER 2.",
    title: "Framework Implementation and Training",
    description:
      "Our certified coaches implement agile frameworks, train your teams, and establish effective practices that promote collaboration and productivity.",
  ...
  },
  {
    ...
    description:
      "We monitor progress, facilitate retrospectives, and help scale agile practices across your organization for sustained improvement and growth.",
  ...
  [
    {
      ...
      title: "PROCESS INNOVATION' 23",
    },
    {
      image: "https://c.animaapp.com/mfo404djpVGKfZ/img/images--1--1.png",
      alt: "Agile Pioneer",
      title: "AGILE PIONEER' 24",
    },
    null,
  ],
];

export const AgileMainContentSection = (): JSX.Element => {
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <section className="flex flex-col min-h-[1120px] items-center justify-center w-full relative">
        <div className="w-full h-[1120px] bg-[#f971161a] absolute inset-0" />
            ...
            {capabilitiesData.map((capability, index) => (
              ...
              >
                <CardContent className="flex flex-col items-start justify-between p-[18px] h-full">
                  <div className="w-16 h-[63px] bg-[#f971161a] rounded-[10px] flex items-center justify-center group-hover:bg-[#f97316] transition-colors duration-300">
                    <img
          ...
          <div className="flex items-center justify-center w-full">
            ...
            <div className="flex flex-col items-start gap-8 pl-24 pr-0 py-24 flex-1 bg-[#ffffff]">
              <div className="flex items-center gap-4 mb-6">
                ...
                >
                  <div className="flex w-14 h-14 items-center justify-center gap-2.5 p-3.5 bg-[#151517] rounded-[50px] shadow-outline-shadow-animation hover:bg-[#f97316] transition-colors duration-300">
              ...
              <div className="gap-3 flex flex-col items-start w-full">
                <div className="mt-[-1.00px] text-[#101014] text-[length:var(--title-h3-font-size)] tracking-[var(--title-h3-letter-spacing)] leading-[var(--title-h3-line-height)] w-full font-title-h3 font-[number:var(--title-h3-font-weight)] [font-style:var(--title-h3-font-style)]">
                  We specialize in agile transformation, team coaching, and process optimization.
                </div>
              </div>
                ...
                <AccordionItem value="item-1" className="border-0">
                  <AccordionTrigger className="flex h-10 items-center w-full hover:no-underline">
                    <div className="flex items-center gap-4 w-full">
                      ...
                      <div className="flex items-center justify-center flex-1 mt-[-1.00px] font-title-h6 font-[number:var(--title-h6-font-weight)] text-[#101014] text-[length:var(--title-h6-font-size)] tracking-[var(--title-h6-letter-spacing)] leading-[var(--title-h6-line-height)] [font-style:var(--title-h6-font-style)]">
                        What agile services do we provide?
                      </div>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="flex flex-col items-start gap-4 px-0 py-1 w-full">
                    <div className="w-full mt-[-1.00px] font-body-base font-[number:var(--body-base-font-weight)] text-[#151517] text-[length:var(--body-base-font-size)] tracking-[var(--body-base-letter-spacing)] leading-[var(--body-base-line-height)] [font-style:var(--body-base-font-style)]">
                      We offer comprehensive agile solutions including Scrum implementation, Kanban setup, team coaching, agile training, and organizational transformation.
                    </div>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-3" className="border-0">
                  <AccordionTrigger className="h-11 flex items-center w-full hover:no-underline">
                    <div className="flex items-center gap-4 w-full">
                      ...
                      <div className="flex items-center justify-center flex-1 mt-[-1.00px] font-title-h6 font-[number:var(--title-h6-font-weight)] text-[#101014] text-[length:var(--title-h6-font-size)] tracking-[var(--title-h6-letter-spacing)] leading-[var(--title-h6-line-height)] [font-style:var(--title-h6-font-style)]">
                        Can you train our existing teams?
                      </div>
                    </div>
                  </AccordionTrigger>
                </AccordionItem>
      ...
      <section className="w-full">
        <div className="w-full max-w-[1312px] mx-auto px-4">
          <div className="flex items-center justify-center gap-10 w-full">
            <div className="flex flex-col items-start justify-center gap-8 flex-1 bg-[#f971161a]">
              <div className="w-full h-[806px] bg-[#f97316] overflow-hidden relative">
          ...
          <div className="flex items-start gap-8 w-full">
            ...
            <div className="flex flex-col items-start justify-center gap-8 flex-1">
              <div className="w-[542px] mt-[-1.00px] [font-family:'Inter',Helvetica] font-normal text-[#151517] text-[17.2px] tracking-[-0.34px] leading-[27.5px]">
                ...
                <span className="font-bold tracking-[-0.06px]">team coaching</span>
      ...
      <div className="flex w-full max-w-[1312px] mx-auto px-4 items-start gap-8 relative">
        ...
        <div className="flex flex-col w-full max-w-[528px] items-start justify-center gap-8 pt-0 pb-2 px-0">
          <div className="gap-3 flex flex-col items-start w-full">
            ...
            <div className="text-[#101014] text-[length:var(--title-h2-font-size)] tracking-[var(--title-h2-letter-spacing)] leading-[var(--title-h2-line-height)] w-full font-title-h2 font-[number:var(--title-h2-font-weight)] [font-style:var(--title-h2-font-style)]">
              Where efficiency meets collaboration
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-center gap-8 w-full">
            <div className="flex flex-col items-start justify-center gap-8 flex-1">
              <div className="w-full mt-[-1.00px] font-body-large font-[number:var(--body-large-font-weight)] text-[#ffffffbf] text-[length:var(--body-large-font-size)] tracking-[var(--body-large-letter-spacing)] leading-[var(--body-large-line-height)] [font-style:var(--body-large-font-style)]">
                We&apos;re agile transformation specialists who are passionate about empowering teams to deliver value faster through proven methodologies and continuous improvement practices.
              </div>
            </div>
