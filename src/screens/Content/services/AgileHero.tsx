  ...
  return (
    ...
    <div className="relative w-[1680px] h-[850px] bg-white overflow-hidden">
      <div className="relative -top-[300px]">
        {/* Soft orange radial glow for Agile */}
        <div className="absolute top-0 left-[364px] w-[960px] h-[960px] rounded-[480px] [background:radial-gradient(50%_50%_at_50%_50%,rgba(249,115,22,0.75)_0%,rgba(249,115,22,0)_100%)]" />
